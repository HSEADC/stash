...
document.addEventListener('DOMContentLoaded', function () {
  function setupMenuToggle(triggerSelector, targetSelectors, textOpen, textClose) {
    var trigger = document.querySelector(triggerSelector);
    if (!trigger) return;
    var hiddenArticles = document.querySelectorAll(targetSelectors);
    trigger.addEventListener('click', function () {
      hiddenArticles.forEach(function (item) {
        return item.classList.toggle('visible');
      });
  ...
  var relations = [{
    ...
    button: '.M_D9ArticlesWindows',
    article: '.O_ArticleRead8'
  }, {
    button: '.M_D10ArticlesWindows',
    article: '.O_ArticleRead9'
  }, {
    button: '.M_D11ArticlesWindows',
    article: '.O_ArticleRead10'
  }, {
    button: '.M_D12ArticlesWindows',
    article: '.O_ArticleRead6'
  }, {
    button: '.M_D13ArticlesWindows',
    article: '.O_ArticleRead11'
  }, {
    button: '.M_D14ArticlesWindows',
    article: '.O_ArticleRead12'
  }, {
    button: '.M_D15ArticlesWindows',
    article: '.O_ArticleRead13'
  }, {
    button: '.M_D16ArticlesWindows',
    article: '.O_ArticleRead14'
  }, {
    button: '.M_D17ArticlesWindows',
    article: '.O_ArticleRead15'
  }, {
    button: '.M_D18ArticlesWindows',
    article: '.O_ArticleRead16'
  }, {
    button: '.M_D19ArticlesWindows',
    article: '.O_ArticleRead17'
  }, {
    button: '.M_D20ArticlesWindows',
    article: '.O_ArticleRead18'
  }, {
    button: '.M_D21ArticlesWindows',
    article: '.O_ArticleRead19'
  }, {
  ...
  var firstArticle = document.querySelector('.O_ArticleRead1');
  if (firstArticle) {
  ...
  var searchInput = document.querySelector('.A_SearchInput');
  var categoriesConfig = [{
    trigger: '.M_BigArticle1',
    targets: ['.M_D8ArticlesWindows', '.M_D9ArticlesWindows', '.M_D10ArticlesWindows', '.M_D11ArticlesWindows'],
    textClose: 'Странности ↓'
  }, {
    trigger: '.M_BigArticle2',
    targets: ['.M_D3ArticlesWindows', '.M_D12ArticlesWindows', '.M_D13ArticlesWindows', '.M_D14ArticlesWindows', '.M_D15ArticlesWindows', '.M_D16ArticlesWindows', '.M_D17ArticlesWindows', '.M_D18ArticlesWindows'],
    textClose: 'Соцсети ↓'
  }, {
  ...
  if (searchInput) {
    searchInput.addEventListener('input', function () {
      ...
      if (query === '') {
        topButtons.forEach(function (selector) {
          var btn = document.querySelector(selector);
          if (btn) btn.style.display = '';
        });
        categoriesConfig.forEach(function (cat) {
          var trigger = document.querySelector(cat.trigger);
          if (trigger) {
            trigger.style.display = '';
            var h5 = trigger.querySelector('h5');
            if (h5) h5.innerHTML = cat.textClose;
          }
          cat.targets.forEach(function (targetSelector) {
      ...
      categoriesConfig.forEach(function (cat) {
        var triggerElement = document.querySelector(cat.trigger);
        if (triggerElement) {
