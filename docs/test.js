...
var tests = __webpack_require__(8051);
...
var testsData = [{
  ...
  id: 4,
  stages: [{
    question: 'Какой вывод лучше всего показывает различие не по датам, а по устройству среды?',
    imgTop: Q_D2APPLE_namespaceObject,
    imgBottom: Q_D1BURGER_namespaceObject,
    answers: [{
      text: ' Все три площадки выполняют одну и ту же функцию и почти не отличаются культурно',
      count: 0
    }, {
      text: 'Разница между ними сводится только к языку интерфейса',
      count: 0
    }, {
      text: ' Они представляют разные модели фанфикшен-интернета',
      count: 1
    }, {
      text: ' Их главное отличие только в цветовом оформлении сайта',
      count: 0
    }]
  }, {
    ...
    imgBottom: Q_D4LEMON_namespaceObject,
    answers: [{
      text: 'От раннего крупного англоязычного архива с более жесткой структурой к локальной русскоязычной платформе и далее к международному некоммерческому архиву',
      count: 0
    }, {
