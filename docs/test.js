...
var testsData = [{
  ...
  id: 2,
  stages: [{
    question: 'Какая крипипаста изначально выросла не из рассказа, а из фотоманипуляции в интернет-конкурсе?',
    imgTop: Q_D2APPLE_namespaceObject,
    imgBottom: Q_D1BURGER_namespaceObject,
    answers: [{
    ...
    question: 'Что лучше всего отличает Smile Dog от многих других классических крипипаст?',
    imgTop: Q_D2GREEN_namespaceObject,
    imgBottom: Q_D1SMILE_namespaceObject,
    answers: [{
      ...
      text: 'Она строится как серия детских телепередач',
      count: 0
    }, {
      text: 'Она оформлена как дневник разработчика видеоигры',
      count: 0
    }, {
      text: 'Она изначально существовала как ARG на YouTube',
      count: 0
    }]
  }, {
    question: 'С какой крипипастой сильнее всего связан образ цифрового вторжения в видеоигру и «испорченного» ROM-файла?',
    imgTop: Q_D1BIRD_namespaceObject,
    imgBottom: Q_D5LEMON_namespaceObject,
    answers: [{
      text: 'Candle Cove',
    ...
    question: 'Какая история больше всего похожа на псевдонаучный или псевдодокументальный эксперимент, а не на личную встречу с монстром?',
    imgTop: Q_D2PURPLE_namespaceObject,
    imgBottom: Q_D2COCO_namespaceObject,
    answers: [{
      text: 'The Russian Sleep Experiment',
    ...
    imgBottom: Q_D1GIRL_namespaceObject,
    answers: [{
      text: 'Историю о маньяке с искаженным лицом',
      count: 0
    }, {
      text: 'Историю о странной детской телепередаче, которую взрослые помнят не так, как дети',
      count: 1
    }, {
      text: 'Историю о проклятой фотографии собаки',
      count: 0
    }, {
      text: 'Историю о существе из леса без лица',
      count: 0
    }]
  }, {
    question: 'Чем Jeff the Killer отличается от Smile Dog или BEN Drowned по типу ужаса?',
    imgTop: Q_D2TV_namespaceObject,
    imgBottom: Q_D1CLOWN_namespaceObject,
    answers: [{
      ...
      text: 'Он целиком основан на найденной телезаписи',
      count: 0
    }, {
      text: 'Он всегда существует только как серия стримов',
      count: 0
    }, {
    ...
    question: 'Какая крипипаста сильнее всего связана с образом заброшенного тематического пространства и тревожного «закулисья» известного бренда?',
    imgTop: Q_D1SHUKA_namespaceObject,
    imgBottom: Q_D4LEMON_namespaceObject,
    answers: [{
      text: 'The Rake',
      ...
      text: 'Lavender Town Syndrome',
      count: 0
    }]
  }, {
    question: 'Почему Slender Man часто стоит особняком даже среди очень известных крипипаст?',
    imgTop: Q_D1ORANGE_namespaceObject,
    imgBottom: Q_D2WIZARD_namespaceObject,
    answers: [{
  ...
  stages: [{
    ...
    answers: [{
      ...
      text: 'Это был мессенджер со статусами присутствия',
      count: 0
    }, {
      text: 'Это была площадка для анонимных вопросов',
      count: 0
    }]
  }, {
    ...
    imgBottom: Q_D1SMILE_namespaceObject,
    answers: [{
      text: 'Публикация всех сообщений в общем профиле',
      count: 0
    }, {
      text: 'Встроенная система форумных тредов',
      count: 0
    }, {
    ...
    answers: [{
      ...
      text: 'Он существовал как каталог домашних страниц',
      count: 0
    }, {
      text: 'Он был сервисом мгновенных сообщений',
      count: 0
    }]
  }, {
    ...
    imgBottom: Q_D2COCO_namespaceObject,
    answers: [{
      text: 'Для хранения черновиков постов',
      count: 0
    }, {
      text: 'Для загрузки файлов на сайт',
      count: 0
    }, {
      text: 'Для приватной связи между админами',
      count: 0
    }, {
    ...
    imgBottom: Q_D1GIRL_namespaceObject,
    answers: [{
      text: 'Людей, добавленных в свою ленту чтения',
      count: 1
    }, {
      text: 'Только взаимных друзей из реальной жизни',
      count: 0
    }, {
      text: 'Авторов, которых продвигал алгоритм',
      count: 0
    }, {
      text: 'Модераторов тематических сообществ',
      count: 0
    }]
  }, {
    ...
    answers: [{
      ...
      text: 'Список избранных контактов',
      count: 0
    }]
  }, {
    question: 'Какая черта помогала Dirty.ru сохранять ощущение закрытого сообщества?',
    imgTop: Q_D1SHUKA_namespaceObject,
    imgBottom: Q_D4LEMON_namespaceObject,
    answers: [{
      text: 'Полное отсутствие рейтингов и голосования',
      count: 0
    }, {
      text: 'Запрет на публикацию изображений',
      count: 0
    }, {
      text: 'Доступ только с мобильных устройств',
      count: 0
    }, {
    ...
    answers: [{
      ...
      text: 'Ее мог видеть только автор сайта',
      count: 0
    }, {
      text: 'Она работала только через e-mail',
      count: 0
    }, {
      text: 'Она автоматически удалялась через сутки',
      count: 0
    }]
  }],
  results: [{
  ...
  stages: [{
    ...
    question: 'Если исследователь говорит, что платформа ощущается как “архив”, а не как “соцсеть”, и особенно подчеркивает систему предупреждений, тегов и контроль автора над доступом к работе, о чем, скорее всего, речь?',
    imgTop: Q_D2GREEN_namespaceObject,
    imgBottom: Q_D1SMILE_namespaceObject,
    answers: [{
      text: 'AO3',
    ...
    question: 'Какая из особенностей сильнее всего ассоциируется именно со старой логикой FanFiction.net, а не с позднейшими архивами?',
    imgTop: Q_D1BIRD_namespaceObject,
    imgBottom: Q_D5LEMON_namespaceObject,
    answers: [{
      ...
      text: 'Публикация только по приглашениям',
      count: 0
    }]
  }, {
    question: 'Что лучше всего показывает принципиальную разницу между AO3 и FanFiction.net как этапами фанфикшен-культуры?',
    imgTop: Q_D2PURPLE_namespaceObject,
    imgBottom: Q_D2COCO_namespaceObject,
    answers: [{
    ...
    question: 'Какой набор признаков лучше всего указывает на Ficbook, а не на две другие площадки?',
    imgTop: Q_D1RED_namespaceObject,
    imgBottom: Q_D1GIRL_namespaceObject,
    answers: [{
    ...
    question: 'Как точнее всего описать различие исторических траекторий FanFiction.net, Ficbook и AO3?',
    imgTop: Q_D1SHUKA_namespaceObject,
    imgBottom: Q_D4LEMON_namespaceObject,
    answers: [{
    ...
    imgBottom: Q_D2WIZARD_namespaceObject,
    answers: [{
      text: 'Волонтерская инфраструктура',
      count: 0
    }, {
      text: 'Неприбыльная модель под OTW',
      count: 0
    }, {
      text: 'Жесткая зависимость от единой фиксированной рубрикации без развитой теговой гибкости',
      count: 1
    }, {
      text: 'Возможности для ограничения доступа к работам',
      count: 0
    }]
  }],
  results: [{
  ...
  id: 5,
  stages: [{
    question: 'Что лучше всего объясняет, почему Flash стал не просто технологией, а целой культурной средой?',
    imgTop: Q_D2APPLE_namespaceObject,
    imgBottom: Q_D1BURGER_namespaceObject,
    answers: [{
      ...
      text: 'Он работал только на фанатских сайтах и форумах',
      count: 0
    }, {
    ...
    question: 'Почему исчезновение Flash воспринимается как потеря части интернет-культуры, а не только как смена софта?',
    imgTop: Q_D2GREEN_namespaceObject,
    imgBottom: Q_D1SMILE_namespaceObject,
    answers: [{
    ...
    question: 'Что в культуре Winamp-скинов было самым показательным для раннего персонального компьютера как “личной территории”?',
    imgTop: Q_D1BIRD_namespaceObject,
    imgBottom: Q_D5LEMON_namespaceObject,
    answers: [{
    ...
    question: 'Почему табличная верстка когда-то была не странной ошибкой, а нормальным решением?',
    imgTop: Q_D2PURPLE_namespaceObject,
    imgBottom: Q_D2COCO_namespaceObject,
    answers: [{
    ...
    question: 'Что точнее всего отличает домашнюю страницу старого веба от профиля в современной платформе?',
    imgTop: Q_D1RED_namespaceObject,
    imgBottom: Q_D1GIRL_namespaceObject,
    answers: [{
    ...
    question: 'Почему старые мессенджеры вроде ICQ стали культурным явлением, а не просто программами для сообщений?',
    imgTop: Q_D2TV_namespaceObject,
    imgBottom: Q_D1CLOWN_namespaceObject,
    answers: [{
      text: 'Они заменяли пользователю браузер и поиск',
      count: 0
    }, {
      text: 'Они создавали новый опыт постоянного присутствия другого человека через статусы, контакт-листы и ожидание ответа',
      count: 1
    }, {
      text: 'Они были первыми сайтами с комментариями',
      count: 0
    }, {
    ...
    question: 'Что объединяет Flash, Winamp-скины и домашние страницы на уровне пользовательского опыта?',
    imgTop: Q_D1SHUKA_namespaceObject,
    imgBottom: Q_D4LEMON_namespaceObject,
    answers: [{
    ...
    question: 'Почему табличная верстка сегодня воспринимается как симптом старого веба?',
    imgTop: Q_D1ORANGE_namespaceObject,
    imgBottom: Q_D2WIZARD_namespaceObject,
    answers: [{
      ...
      text: 'Потому что она работала только в одном браузере',
      count: 0
    }]
  }],
  results: [{
  ...
  id: 6,
  stages: [{
    question: 'Что лучше всего описывает Rule 43 в контексте старого интернет-фольклора?',
    imgTop: Q_D2APPLE_namespaceObject,
    imgBottom: Q_D1BURGER_namespaceObject,
    answers: [{
      ...
      text: 'У каждого фандома есть собственный канон правил',
      count: 0
    }]
  }, {
    question: 'Что делает Smile HD особенно показательной вещью для этой логики?',
    imgTop: Q_D2GREEN_namespaceObject,
    imgBottom: Q_D1SMILE_namespaceObject,
    answers: [{
    ...
    answers: [{
      ...
      text: 'Pony.mov вообще не связан с MLP-фандомом',
      count: 0
    }]
  }, {
    ...
    question: 'Что лучше всего отличает Don’t Hug Me I’m Scared от Smile HD и Pony.mov?',
    imgTop: Q_D1RED_namespaceObject,
    imgBottom: Q_D1GIRL_namespaceObject,
    answers: [{
      text: 'Это не анимация и не музыкальный формат',
      count: 0
    }, {
      ...
      text: 'Это имиджбордный мем без стабильного сюжета',
      count: 0
    }]
  }, {
    question: 'Почему Happy Tree Friends так хорошо вписывается в поле вокруг Rule 43?',
    imgTop: Q_D2TV_namespaceObject,
    imgBottom: Q_D1CLOWN_namespaceObject,
    answers: [{
    ...
    question: 'Какой из этих примеров лучше всего относится к фанатскому grimdark-переосмыслению детской франшизы, а не к полностью самостоятельному авторскому хоррору?',
    imgTop: Q_D1SHUKA_namespaceObject,
    imgBottom: Q_D4LEMON_namespaceObject,
    answers: [{
      text: 'Don’t Hug Me I’m Scared',
      count: 0
    }, {
      text: 'Happy Tree Friends',
      count: 0
    }, {
      text: 'Rule 43 как список правил',
      count: 0
    }, {
      text: 'Rainbow Factory',
      count: 1
    }]
  }, {
    question: 'Почему реакционные видео стали важной частью жизни Smile HD?',
    imgTop: Q_D1ORANGE_namespaceObject,
    imgBottom: Q_D2WIZARD_namespaceObject,
    answers: [{
...
var testId = Number(document.body.getAttribute('test_id')) || 1;
var currentTest = testsData.find(function (t) {
  return t.id === testId;
});
if (currentTest) {
  (0,tests/* initTest */.v)(currentTest.stages);
  (0,tests/* chooseAnswer */.I)(currentTest.stages, currentTest.results);
} else {
